...
#    Updated: 2024/05/03 13:07:47 by hidriouc         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
lib = lib/ft_strdup.c lib/str_join.c lib/ft_strlen.c lib/ft_strtrim.c\
	...
	lib/ft_lstadd_back.c lib/ft_lstnew.c lib/ft_lstlast.c lib/ft_strncmp.c
...
utils = utils/print_error.c utils/is_token.c utils/parsing_utils.c utils/split_cmd.c\
		...
		utils/builtins/ft_pwd.c utils/builtins/ft_echo.c
